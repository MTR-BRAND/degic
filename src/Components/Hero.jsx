    ...
    <>
        <section className='flex flex-col-reverse lg:flex-row items-center justify-between gap-8 py-16 px-6 lg:px-16 container max-w-[1400px] mx-auto'>
          ...
          <div className='flex-1 flex flex-col items-start gap-8'>
            <h1 className='text-3xl sm:text-4xl lg:text-6xl font-bold max-w-lg mt-2'>Simply explained with illustrations</h1>
          ...
          <div className='flex-1'>
            <img className='w-full h-auto max-w-lg' src="/rocket.png" alt="Rocket illustration" />
          </div>
